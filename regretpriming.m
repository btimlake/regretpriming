addpath('REGRET_task', 'patentTaskBTMP', 'rating-slider');
sca;
close all;
clearvars;
...
[window, windowRect] = PsychImaging('OpenWindow', screenNumber, white, [0 0 640 480]); % for two-screen setup

%% call scripts
regretTask;
regretTask1shot;
patentTaskBTMP(particNum, DateTime, window, windowRect);
